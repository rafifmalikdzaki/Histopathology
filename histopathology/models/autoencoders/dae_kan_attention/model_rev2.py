...
# Each decoder should be update further
...
class Autoencoder_Decoder(nn.Module):
    ...
    def __init__(self, device: str = 'cuda'):
        ...
        # Decoder can be accelerated using upsampling method and decrease artifacts in the output 
        # Calculation should be done to get desired dimentions
        self.decoder1 = nn.Sequential(
            nn.BatchNorm2d(64),
            nn.ConvTranspose2d(64, 128, kernel_size=3, padding=1, stride=2, output_padding=1),
            nn.BatchNorm2d(128),
...
# This should be revised using a 1 x 1 stride or 1 x 1 kernel from reconstruction
